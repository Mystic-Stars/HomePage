...
export default function ThemeSwitch() {
  ...
  return (
    <button
      className="w-[2.5rem] h-[2.5rem] bg-opacity-80 flex items-center justify-center hover:scale-[1.15] active:scale-95 transition-transform text-gray-700 dark:text-gray-200 overflow-hidden relative focus:outline-none"
